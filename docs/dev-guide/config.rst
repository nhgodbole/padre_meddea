...
This package makes use of a settings file (:file:`config.yml`).
This file contains a number of global settings such as the default format for displaying times.
